    ...
    <div className=" bg-gray-900 h-64  flex justify-center relative">
      ...
      <div className=" absolute w-full h-full  ">
        <div className=" w-full h-full   relative ">
          <button className="absolute  top-0 right-0  w-[4.33rem] z-30  rounded-sm text-3xl text-gray-50 transition duration-150 hover:bg-[hsl(0,0%,0%,0.5)] active:text-pink-300 h-full">
